...
class Scoreboard:
    """Класс длы вывода игровой информации"""
    ...
    def __init__(self, ai_settings, screen, stats):
        ...
        # Подготовка исходного изображения, преоброзавания из текста в каритнку
        self.prep_score()
        self.prep_level()
    ...
    def prep_high_score(self):
        high_score_rounded = int(round(self.stats.high_score))
